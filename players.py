...
class SeasonPitchingStats():
	...
	def ParseJson(self, jsonData):
		...
		for index in range(1, self.totalSize):
			...
			self.tr.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['tr'])
			self.gf.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['gf'])
			self.sport_code.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sport_code'])
			self.bqs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['bqs'])
			self.hgnd.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hgnd'])
			self.sho.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sho'])
			self.bq.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['bq'])
			self.gidp_opp.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['gidp_opp'])
			self.bk.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['bk'])
			self.kbb.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['kbb'])
			self.sport_id.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sport_id'])
			self.hr9.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hr9'])
			self.sv.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sv'])
			self.slg.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['slg'])
			self.bb.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['bb'])
			self.whip.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['whip'])
			self.avg.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['avg'])
			self.ops.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ops'])
			self.team_full.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['team_full'])
			self.db.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['db'])
			self.league_full.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['league_full'])
			self.team_abbrev.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['team_abbrev'])
			self.hfly.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hfly'])
			self.so.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['so'])
			self.tbf.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['tbf'])
			self.bb9.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['bb9'])
			self.league_id.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['league_id'])
			self.wp.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['wp'])
			self.team_seq.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['team_seq'])
			self.hpop.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hpop'])
			self.league.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['league'])
			self.hb.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hb'])
			self.cs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['cs'])
			self.pgs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['pgs'])
			self.season.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['season'])
			self.sb.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sb'])
			self.go_ao.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['go_ao'])
			self.ppa.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ppa'])
			self.cg.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['cg'])
			self.player_id.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['player_id'])
			self.gs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['gs'])
			self.ibb.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ibb'])
			self.team_id.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['team_id'])
			self.pk.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['pk'])
			self.go.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['go'])
			self.hr.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hr'])
			self.irs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['irs'])
			self.wpct.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['wpct'])
			self.era.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['era'])
			self.babip.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['babip'])
			self.end_date.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['end_date'])
			self.rs9.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['rs9'])
			self.qs.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['qs'])
			self.league_short.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['league_short'])
			self.g.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['g'])
			self.ir.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ir'])
			self.hld.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hld'])
			self.k9.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['k9'])
			self.sport.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['sport'])
			self.team_short.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['team_short'])
			self.l.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['l'])
			self.svo.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['svo'])
			self.h.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['h'])
			self.ip.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ip'])
			self.obp.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['obp'])
			self.w.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['w'])
			self.hldr.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['hldr'])
			self.ao.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ao'])
			self.s.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['s'])
			self.r.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['r'])
			self.spct.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['spct'])
			self.pip.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['pip'])
			self.ab.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['ab'])
			self.er.append(jsonData['sport_pitching_tm']['queryResults']['row'][index - 1]['er'])
		'''
		#If there is only one player in the data
		if self.totalSize == 1:
