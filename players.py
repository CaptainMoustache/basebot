...
class SeasonPitchingStats():
	...
	def ParseJson(self, jsonData):
		...
		for index in range(0, self.totalSize):
			self.gidp[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['gidp']
			self.h9[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['h9']
			self.np[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['np']
			self.tr[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['tr']
			self.gf[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['gf']
			self.sport_code[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sport_code']
			self.bqs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['bqs']
			self.hgnd[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hgnd']
			self.sho[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sho']
			self.bq[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['bq']
			self.gidp_opp[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['gidp_opp']
			self.bk[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['bk']
			self.kbb[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['kbb']
			self.sport_id[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sport_id']
			self.hr9[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hr9']
			self.sv[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sv']
			self.slg[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['slg']
			self.bb[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['bb']
			self.whip[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['whip']
			self.avg[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['avg']
			self.ops[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ops']
			self.team_full[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['team_full']
			self.db[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['db']
			self.league_full[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['league_full']
			self.team_abbrev[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['team_abbrev']
			self.hfly[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hfly']
			self.so[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['so']
			self.tbf[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['tbf']
			self.bb9[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['bb9']
			self.league_id[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['league_id']
			self.wp[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['wp']
			self.team_seq[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['team_seq']
			self.hpop[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hpop']
			self.league[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['league']
			self.hb[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hb']
			self.cs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['cs']
			self.pgs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['pgs']
			self.season[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['season']
			self.sb[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sb']
			self.go_ao[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['go_ao']
			self.ppa[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ppa']
			self.cg[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['cg']
			self.player_id[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['player_id']
			self.gs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['gs']
			self.ibb[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ibb']
			self.team_id[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['team_id']
			self.pk[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['pk']
			self.go[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['go']
			self.hr[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hr']
			self.irs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['irs']
			self.wpct[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['wpct']
			self.era[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['era']
			self.babip[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['babip']
			self.end_date[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['end_date']
			self.rs9[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['rs9']
			self.qs[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['qs']
			self.league_short[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['league_short']
			self.g[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['g']
			self.ir[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ir']
			self.hld[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hld']
			self.k9[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['k9']
			self.sport[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['sport']
			self.team_short[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['team_short']
			self.l[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['l']
			self.svo[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['svo']
			self.h[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['h']
			self.ip[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ip']
			self.obp[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['obp']
			self.w[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['w']
			self.hldr[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['hldr']
			self.ao[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ao']
			self.s[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['s']
			self.r[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['r']
			self.spct[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['spct']
			self.pip[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['pip']
			self.ab[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['ab']
			self.er[index] = jsonData['sport_pitching_tm']['queryResults'][index]['row']['er']
		'''
		#If there is only one player in the data
		if self.totalSize == 1:
